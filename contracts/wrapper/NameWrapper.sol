    ...
    ReverseClaimer
{
    ...
    bytes32 private constant ETH_NODE =
        0x3b824164e1f42aecd346157a54c3605fb67634a4f8f71cc0d4920f05d7fdb6ce;
    bytes32 private constant ETH_LABELHASH =
        0xe97aa60a8fe55fbe2a2888a245506b9a141f7e336df50c9c08ac63b21681369a;
     ...
     * @param id Label as a string of the .jib domain to wrap
    ...
    /**
     * @notice Wraps a .jib domain, creating a new token and sending the original ERC721 token to this contract
     * @dev Can be called by the owner of the name on the .jib registrar or an authorised caller on the registrar
     * @param label Label as a string of the .jib domain to wrap
    ...
    /**
     * @dev Registers a new .jib second-level domain and wraps it.
     *      Only callable by authorised controllers.
     * @param label The label to register (Eg, 'foo' for 'foo.jib').
     * @param wrappedOwner The owner of the wrapped name.
     * @param duration The duration, in seconds, to register the name for.
     * @param resolver The resolver address to set on the ENS registry (optional).
     * @param ownerControlledFuses Initial owner-controlled fuses to set
     * @return registrarExpiry The expiry date of the new name on the .jib registrar, in seconds since the Unix epoch.
     */
    ...
    /**
     * @notice Renews a .jib second-level domain.
     * @dev Only callable by authorised controllers.
     * @param tokenId The hash of the label to register (eg, `keccak256('foo')`, for 'foo.jib').
     * @param duration The number of seconds to renew the name for.
     * @return expires The expiry date of the name on the .jib registrar, in seconds since the Unix epoch.
     */
    ...
    /**
     * @notice Wraps a non .jib domain, of any kind. Could be a DNSSEC name jibchain.xyz or a subdomain
    ...
    /**
     * @notice Unwraps a .jib domain. e.g. jibchain.jib
     * @dev Can be called by the owner in the wrapper or an authorised caller in the wrapper
     * @param labelhash Labelhash of the .jib domain
     * @param registrant Sets the owner in the .jib registrar to this address
    ...
    /**
     * @notice Unwraps a non .jib domain, of any kind. Could be a DNSSEC name jibchain.xyz or a subdomain
     * @dev Can be called by the owner in the wrapper or an authorised caller in the wrapper
     * @param parentNode Parent namehash of the name e.g. jibchain.xyz would be namehash('xyz')
     * @param labelhash Labelhash of the name, e.g. jibchain.xyz would be keccak256('jibchain')
     * @param controller Sets the owner in the registry to this address
     */
    ...
    /**
     * @notice Upgrades a domain of any kind. Could be a .jib name jibchain.jib, a DNSSEC name jibchain.xyz, or a subdomain
    ...
    function _beforeTransfer(
        ...
        // For this check, treat .jib 2LDs as expiring at the start of the grace period.
        if (fuses & IS_DOT_ETH == IS_DOT_ETH) {
            expiry -= GRACE_PERIOD;
        }
    ...
    function _normaliseExpiry(
        ...
        // .jib names will check registrar, non .jib check parent
        if (expiry > maxExpiry) {
            expiry = maxExpiry;
        }
    ...
    function _wrapETH2LD(
        ...
        bytes memory name = _addLabel(label, "\x03jib\x00");
        names[node] = name;
